  ...
  return (
    <LayOutAuth heading="Sign Up">
      <div className="mb-2 text-center lg:mb-5 ">
        ...
        <button
          type="button"
          className="flex items-center justify-center w-full gap-3 py-2 mb-5 border-2 rounded-lg lg:py-3 dark:border-white dark:text-white border-whiteStock "
        >
        ...
        <p className="text-xs lg:text-sm text-text2 dark:text-white">
